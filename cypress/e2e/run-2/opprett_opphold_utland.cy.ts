...
describe('Tester opprettelse av søknad om å beholde sykepenger utenfor EU/EØS/Storbritannia', () => {
    before(() => {
    ...
    it('Søknad UTLANDSOPPHOLD_SOKT_SYKEPENGER - steg 2', function () {
        ...
        // Test spørsmål
        cy.get('.sporsmal__tittel').should('have.text', 'Sykepenger utenfor EU/EØS/Storbritannia')
        cy.contains('Har du søkt om å beholde sykepengene for de dagene du var utenfor EU/EØS/Storbritannia?')
    ...
    it('Vi åpner opprettelse av søknad siden', function () {
        ...
        cy.contains('Søknad om å beholde sykepenger utenfor EU/EØS/Storbritannia')
