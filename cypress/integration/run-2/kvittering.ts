    ...
    context('Arbeidsledig', () => {
        it('Nylig sendt', () => {
            ...
            cy.get('.opplysninger.navds-alert--info')
                ...
                .and('contain', 'Saksbehandlingstiden regnes fra NAV har mottatt all nødvendig dokumentasjon. Etter dette må du regne med å vente minst fire uker før søknaden er behandlet. Men saksbehandlingstidene kan variere noe. Sjekk saksbehandlingstidene i ditt fylke')
    ...
    context('Utland', () => {
        it('Nylig sendt', () => {
            ...
            cy.get('.opplysninger.navds-alert--info')
                ...
                .and('not.contain', 'Saksbehandlingstiden regnes fra NAV har mottatt all nødvendig dokumentasjon. Etter dette må du regne med å vente minst fire uker før søknaden er behandlet. Men saksbehandlingstidene kan variere noe. Sjekk saksbehandlingstidene i ditt fylke')
