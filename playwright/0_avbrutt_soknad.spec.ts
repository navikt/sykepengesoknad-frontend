...
test.describe('Tester avbryting av søknad', () => {
    ...
    test('Full flow for avbryting av søknad', async ({ page }) => {
        ...
        await harSynligTekst(page, 'Du har fjernet søknaden, som betyr at du ikke vil få sykepenger basert på denne søknaden');
        ...
        await harSynligTekst(page, 'Hvis du er sykmeldt fra flere arbeidsgivere, må du sende én søknad for hver arbeidsgiver.');
        await harSynligTekst(
            page,
