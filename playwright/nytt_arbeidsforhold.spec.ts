...
test.describe('Tester nytt arbeidsforhold', () => {
    ...
    test('Får spesifikk hjelpetekst ved ja på ferie', async ({ page }) => {
        ...
        await svarJaHovedsporsmal(page)
        await expect(page.getByText('Ikke ta med det du eventuelt tjente de dagene du hadde ferie fra MATBUTIKKEN AS.')).toBeVisible()
    })
    ...
    test('Får spesifikk hjelpetekst ved ja på permisjon', async ({ page }) => {
        ...
        await svarJaHovedsporsmal(page)
        await expect(page.getByText('Ikke ta med det du eventuelt tjente de dagene du hadde permisjon fra MATBUTIKKEN AS.')).toBeVisible()
    })
    ...
    test('Får spesifikk hjelpetekst ved ja på ferie og permisjon', async ({ page }) => {
        ...
        await svarJaHovedsporsmal(page)
        await expect(page.getByText('Ikke ta med det du eventuelt tjente de dagene du hadde ferie eller permisjon fra MATBUTIKKEN AS.')).toBeVisible()
    })
})
