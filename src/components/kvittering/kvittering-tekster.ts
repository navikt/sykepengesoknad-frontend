const KvitteringTekster: any = {
    'nb': {
        ...
        'kvittering.soker-du-etter': 'Søker du etter arbeidsgiverperioden må arbeidsgiveren din sende inn inntekts-melding så fort som mulig. Er du usikker på om den er sendt, bør du forhøre deg med arbeidsgiveren din.',
        ...
        'kvittering.arbeidstaker.over16.inntektsmelding.brodtekst': 'Arbeidsplassen din sender inntektsopplysninger og annen informasjon som NAV trenger for å behandle søkaden din. Inntektsmeldingen senden digitalt fra arbeidsplassens lønns og personalsystemet eller fra Altinn.no.',
