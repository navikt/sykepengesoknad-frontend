const OpplysningerTekster = {
    ...
    'sykepengesoknad.avbrutt.informasjon-tittel': 'Det betyr at du ikke vil få sykepenger for perioden denne søknaden gjelder for.',
    'sykepengesoknad.avbrutt.informasjon-innhold': 'Hvis du vil ha sykepenger likevel, må du gjenåpne søknaden, fylle den ut og sende den inn. Vi minner om at søknaden må sendes seneste tre måneder etter den måneden hver enkelt sykemelding startet.',
