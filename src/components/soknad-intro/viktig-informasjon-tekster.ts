const ViktigInformasjonTekster = {
    ...
    'viktig-informasjon.avsnitt.3': 'Du kan likevel sende inn søknaden. Når den er behandlet, får du en begrunnelse for hvorfor du ikke får sykepenger for alle dagene. Samtidig får du mulighet til å klage.',
