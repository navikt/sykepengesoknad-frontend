const SoknadenTekster = {
    ...
    'sykepengesoknad.sykepengeinfo.til-nav':
        'Sykepenger utbetales etter at NAV har innvilget søknaden. <a class="navds-link" href="https://www.nav.no/utbetalingsdatoer#sykepenger" target="_blank">Les om sykepenger og saksbehandlingstider.</a>',
    ...
    'sykepengesoknad.utenlandsk_sykmelding_bosted.tittel': 'Bosted',
    'sykepengesoknad.utenlandsk_sykmelding_lonnet_arbeid_utenfor_norge.tittel': 'Lønnet arbeid utenfor Norge',
    'sykepengesoknad.utenlandsk_sykmelding_trygd_utenfor_norge.tittel': 'Sykepenger i andre EU/EØS-land',
    ...
    'sykepengesoknad.medlemskap_oppholdstillatelse_v2.tittel': 'Oppholdstillatelse',
