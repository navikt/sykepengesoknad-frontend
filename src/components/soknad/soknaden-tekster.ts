const SoknadenTekster = {
    ...
    'sykepengesoknad.bekreft_opplysninger_utland.tittel':
        'Bekreft opplysninger',
    'sykepengesoknad.bekreft_opplysninger_utland_info.tittel':
        'Bekreft opplysninger',
    ...
    'sykepengesoknad.ferie.hjelpetekst.tekst':
    ...
    'sykepengesoknad.utlandsopphold_sokt_sykepenger.tittel':
    ...
    'sykepengesoknad.fraver_for_behandling.tittel':
        'Fravær før behandlingsdager',

    'sykepengesoknad.jobbet_du_100_prosent.tittel':
        'Jobb underveis i sykefraværet',
    'sykepengesoknad.aktiviteter.gradert.hjelpetekst.tittel':
        'Gradert sykmelding',
    ...
    'sykepengesoknad.utdanning.fulltidsstudium.sporsmal':
        'Er utdanningen et fulltidsstudium?',
    'sykepengesoknad.utdanning.ja-nei.sporsmal':
        'Har du vært under utdanning i løpet av perioden %STARTDATO% – %SLUTTDATO%?',
    'sykepengesoknad.utdanning.ja-nei.sporsmal-2':
        'Har du vært under utdanning i løpet av perioden %PERIODE%?',
    'sykepengesoknad.utdanning.startdato.sporsmal':
    ...
    'sykepengesoknad.andre-inntektskilder.ANDRE_ARBEIDSFORHOLD.label':
    ...
    'sykepengesoknad.andre-inntektskilder.JORDBRUKER_FISKER_REINDRIFTSUTOEVER.label':
        'Jordbruker / Fisker / Reindriftsutøver',
    'sykepengesoknad.andre-inntektskilder.SELVSTENDIG_NAERINGSDRIVENDE.label':
        'Selvstendig næringsdrivende',
    'sykepengesoknad.andre-inntektskilder.SELVSTENDIG_NAERINGSDRIVENDE_DAGMAMMA.label':
        'Selvstendig næringsdrivende dagmamma',
    'sykepengesoknad.andre-inntektskilder.er-du-sykmeldt-fra-dette.sporsmal':
        'Er du sykmeldt fra dette?',
    'sykepengesoknad.andre-inntektskilder.hvilke-inntektskilder.informasjon':
        'Du trenger ikke oppgi andre ytelser fra NAV.',
    'sykepengesoknad.andre-inntektskilder.hvilke-inntektskilder.sporsmal':
    ...
    'sykepengesoknad.oppsummering.arbeidsgiver-som-mottaker':
        'Søknaden sendes til %ARBEIDSGIVER% med kopi til NAV.',
    ...
    'sykepengesoknad.kvittering.til-nav-arbeidsgiver.tittel':
        'Søknaden er sendt!',
    ...
    'sykepengesoknad.kvittering.til-nav-arbeidsledig.tittel':
        'Søknaden er sendt!',
