const SoknadenTekster = {
    ...
    'sykepengesoknad.nytt_arbeidsforhold_forstegang.tittel': 'Nytt arbeidsforhold',
    'sykepengesoknad.nytt_arbeidsforhold_pafolgende.tittel': 'Inntekt fra annet arbeidsforhold',
