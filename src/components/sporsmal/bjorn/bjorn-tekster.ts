const BjornTekster = {
    ...
    'soknad.bjorn.periodeutland' : 'Vil du beholde sykepengene mens du er utenfor EØS, kan du ikke være borte i mer enn 28 kalenderdager i løpet av en 12 måneders periode.',
