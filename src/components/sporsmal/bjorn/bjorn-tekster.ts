const BjornTekster: any = {
    'nb': {
        ...
        'soknad.bjorn.permittert_naa' : 'Vi spør om permittering for å kunne beregne sykepengene dine riktig.  Les mer om å være både sykmeldt og permittert.',
        'soknad.bjorn.permittert_periode' : 'Tidspunkt og varighet avgjør om sykepengene skal beregnes likt som dagpenger. Derfor spør vi om de fire ukene før du ble sykmeldt. Les mer om å være både sykmeldt og permittert.',
