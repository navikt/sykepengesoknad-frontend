...
const Tag = ({ onDelete, verdi }: TagProps) => {
    return (
        <span className="etikett etikett--info etikett--tag">
            ...
            <button type="button" className="etikett__slett" onClick={onDelete}>
                <span className="etikett__slett-label etikett__slett-label--skjermleser">
                    Slett
                </span>
                <span aria-hidden="true" className="etikett__slett-label">
                    {kryss}
                </span>
            </button>
        </span>
