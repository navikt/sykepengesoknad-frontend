const SporsmalTekster = {
    ...
    'soknad.feilmelding.JOBBET_MER_I_VALG':
        'Du må svare på om du har jobbet mer enn du pleier i et eller flere arbeidsforhold',
    'soknad.feilmelding.ANDRE_INNTEKTSKILDER_V2': 'Du må svare på om du har annen inntekt eller oppdrag',
    ...
    'soknad.undertekst.HVOR_MANGE_TIMER_PER_UKE': 'Eksempel: 37,5',
