const SporsmalTekster: any = {
    'nb': {
        ...
        "soknad.feilmelding.HVOR_MYE_TIMER_VERDI.lokalt": "Du må fylle ut antall timer",
        ...
        "soknad.feilmelding.INNTEKTSKILDE_ANDRE_ARBEIDSFORHOLD.lokal": "Du må velge ja eller nei",
        "soknad.feilmelding.INNTEKTSKILDE_SELVSTENDIG": "Du må svare på om du er sykmeldt som selvstendig næringsdrivende",
        "soknad.feilmelding.INNTEKTSKILDE_SELVSTENDIG.lokal": "Du må velge ja eller nei",
        "soknad.feilmelding.INNTEKTSKILDE_SELVSTENDIG_DAGMAMMA": "Du må svare på om du er sykmeldt som dagmamma",
        "soknad.feilmelding.INNTEKTSKILDE_SELVSTENDIG_DAGMAMMA.lokal": "Du må velge ja eller nei",
        "soknad.feilmelding.INNTEKTSKILDE_JORDBRUKER": "Du må svare på om du er sykmeldt som jordbruker",
        "soknad.feilmelding.INNTEKTSKILDE_JORDBRUKER.lokal": "Du må velge ja eller nei",
        "soknad.feilmelding.INNTEKTSKILDE_FRILANSER": "Du må svare på om du er sykmeldt som frilanser",
        "soknad.feilmelding.INNTEKTSKILDE_FRILANSER.lokal": "Du må velge ja eller nei",
