...
const kjenteTags = [
    ...
    'FTA_JOBBSITUASJONEN_DIN_FORTSATT_ARBEIDSSOKER',
    'FTA_INNTEKT_UNDERVEIS',
    'FTA_INNTEKT_UNDERVEIS_MER_ENN_PLEIER',
    'FTA_INNTEKT_UNDERVEIS_MER_ENN_PLEIER_BELOP',
    'FTA_REISE_TIL_UTLANDET',
    'FTA_REISE_TIL_UTLANDET_NAR',
    'FTA_JOBBSITUASJONEN_DIN_FORTSATT_ARBEIDSSOKER_AVREGISTRERT_NAR',
]
