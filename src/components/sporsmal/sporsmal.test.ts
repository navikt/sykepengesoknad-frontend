...
test('Alle tags har global feilmelding', () => {
    ...
    tags = tags.filter((skipTag) => {
        return (
            ...
            skipTag !== TagTyper.MEDLEMSKAP_UTFORT_ARBEID_UTENFOR_NORGE_PERIODE && // Svartype: IKKE_RELEVANT
            skipTag !== TagTyper.MEDLEMSKAP_OPPHOLD_UTENFOR_EOS_PERIODE && // Svartype: IKKE_RELEVANT
            skipTag !== TagTyper.MEDLEMSKAP_OPPHOLD_UTENFOR_NORGE_PERIODE && // Svartype: IKKE_RELEVANT
