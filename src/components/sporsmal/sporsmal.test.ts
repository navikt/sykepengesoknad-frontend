...
const kjenteTags = [
    ...
    'TILKOMMEN_INNTEKT_FORSTEGANG',
    'TILKOMMEN_INNTEKT_FORSTEGANG_FORSTE_ARBEIDSDAG',
    'TILKOMMEN_INNTEKT_FORSTEGANG_BRUTTO',
    'TILKOMMEN_INNTEKT_PAFOLGENDE',
    'TILKOMMEN_INNTEKT_PAFOLGENDE_BRUTTO',
]
