...
export const OtherJobs = ({ jobsList, plusVisible }: { jobsList: string[]; plusVisible: boolean }) => {
    ...
    return (
        <div>
            ...
            Vi kan se at du har hatt inntekt fra andre steder enn jobben du er sykmeldt fra de siste månedene. Informasjonen er hentet fra Arbeidsgiver- og arbeidstakerregisteret. Vi har noen spørsmål angående når og om du fortsatt jobber der.
            </p>
