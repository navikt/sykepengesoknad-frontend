...
export function jaNeiStorStyle(value: string, watch: any, error: boolean, mt = false) {
    return cn(
        'focus-within:shadow-focus mb-2 block w-full [&>label]:rounded [&>label]:border-2 [&>label]:border-border-default [&>label]:px-4 [&>label]:py-4 text-text-default [&>label]:hover:bg-surface-action-subtle-hover md:mb-0 md:w-1/2 rounded focus:outline-none focus:ring focus:ring-blue-800 focus:ring-opacity-50',
        {
