...
export const brukertestSoknad: RSSoknad = {
    ...
    sporsmal: [
        ...
        {
            id: '54352523',
            tag: 'LONNET_ARBEID_UTENFOR_NORGE',
            ...
            undersporsmal: [
                {
                    id: '254352345',
                    tag: 'LONNET_ARBEID_UTENFOR_NORGE_FRITEKST',
                    sporsmalstekst: 'Oppgi nærmere opplysninger om arbeid/virksomhet utenfor Norge',
                    undertekst:
                        '(f. eks. navn på arbeidsgivere og nærmere informasjon om din yrkesaktivitet i utlandet)\n',
                    svartype: 'FRITEKST',
                    min: null,
                    max: null,
                    pavirkerAndreSporsmal: false,
        ...
        {
            id: '345435435345345',
            tag: 'TRYGD_UTENFOR_NORGE',
            sporsmalstekst: `Har du mottatt sykepenger eller tilsvarende i et annet EØS-land i løpet av de siste tre årene?`,
            undertekst: null,
            svartype: 'JA_NEI',
            min: null,
            max: null,
            ...
            undersporsmal: [
                ...
                {
                    id: '345345345345',
                    tag: 'TRYGD_HVILKEN_YTELSE',
                    sporsmalstekst: 'Navn på ytelse',
                    undertekst: null,
                    svartype: 'FRITEKST',
                    min: null,
                    max: null,
        ...
        },
        {
            id: '523524542',
            tag: 'TURNUS_ROTASJON',
            sporsmalstekst: `Jobber du turnus/rotasjon for ${hovedjobb}?`,
            undertekst: null,
            svartype: 'JA_NEI',
            min: null,
            max: null,
            ...
            undersporsmal: [
                {
                    id: '254352345',
                    tag: 'TURNUS_ROTASJON_NAR',
                    sporsmalstekst: 'Når var siste avspaseringsperiode?',
                    undertekst: null,
                    svartype: 'PERIODER',
                    min: null,
                    max: null,
