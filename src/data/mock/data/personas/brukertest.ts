...
export function brukertest(req?: NextApiRequest): Persona {
    const hovedjobb = (req?.query['hovedjobb'] ?? 'MATBUTIKKEN AS') as string
    const fom = (req?.query['fom'] ?? '2023-12-12') as string
    const tom = (req?.query['tom'] ?? '2024-01-12') as string

    const periodeTekst = tilLesbarPeriodeMedArstall(dayjs(fom), dayjs(tom))
    const brukertestSykmelding = new Sykmelding({
        id: 'abc5acf2-a44f-42e5-87b2-02c9d0b39ce4',
        pasient: {
            fnr: '08089404496',
            fornavn: 'TYKKMAGET',
            mellomnavn: null,
    ...
    const brukertestSoknad: RSSoknad = {
        id: '963e816f-7b3c-4513-818b-95595d84dd97',
        sykmeldingId: 'abc5acf2-a44f-42e5-87b2-02c9d0b39ce4',
