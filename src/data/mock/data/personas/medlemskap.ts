...
const oppholdUtlandSpm = medlemskapOriginalOppholdstillatelse.sporsmal.find((spm) => spm.tag == 'UTLAND_V2')
if (!oppholdUtlandSpm) {
...
medlemskapOppholdstillatelseMidlertidig.kjentOppholdstillatelse = { fom: '2024-05-01', tom: '2024-05-31' }
