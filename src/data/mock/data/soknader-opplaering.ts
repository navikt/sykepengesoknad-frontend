...
export const arbeidstakerGradert = {
...
export const soknaderOpplaering = [ behandlingsdager, arbeidstaker, arbeidstakerGradert, arbeidsledig, frilanser, oppholdUtland, avbruttSoknad ] as any as RSSoknad[]
