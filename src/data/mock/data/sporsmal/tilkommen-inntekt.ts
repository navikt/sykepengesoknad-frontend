...
export const tilkommenInntektForstegangSporsmal = ({
    ...
    return {
        id: v4().toString(),
        tag: 'NYTT_ARBEIDSFORHOLD_FORSTEGANG',
        ...
        undersporsmal: [
            {
                id: v4().toString(),
                tag: 'NYTT_ARBEIDSFORHOLD_FORSTEGANG_FORSTE_ARBEIDSDAG',
            ...
            {
                id: v4().toString(),
                tag: 'NYTT_ARBEIDSFORHOLD_BRUTTO',
...
export const tilkommenInntektPafolgendeSporsmal = ({
    ...
    return {
        id: v4().toString(),
        tag: 'NYTT_ARBEIDSFORHOLD_PAFOLGENDE',
