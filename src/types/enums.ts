...
export enum TagTyper {
    ...
    // egenerklæring
    BOR_I_NORGE = 'BOR_I_NORGE',
    CO = 'CO',
    VEGNAVN = 'VEGNAVN',
    BYGNING = 'BYGNING',
    BY = 'BY',
    REGION = 'REGION',
    LAND_EGENERKLÆRING = 'LAND_EGENERKLÆRING',
    GYLDIGHET_ADRESSE = 'GYLDIGHET_ADRESSE',
    LONNET_ARBEID_UTENFOR_NORGE = 'LONNET_ARBEID_UTENFOR_NORGE',
    LONNET_ARBEID_UTENFOR_NORGE_FRITEKST = 'LONNET_ARBEID_UTENFOR_NORGE_FRITEKST',
    TURNUS_ROTASJON = 'TURNUS_ROTASJON',
    TURNUS_ROTASJON_NAR = 'TURNUS_ROTASJON_NAR',
    UTENLANDSK_ADRESSE = 'UTENLANDSK_ADRESSE',
    TRYGD_UTENFOR_NORGE = 'TRYGD_UTENFOR_NORGE',
    TRYGD_HVILKET_LAND = 'TRYGD_HVILKET_LAND',
    TRYGD_HVILKEN_YTELSE = 'TRYGD_HVILKEN_YTELSE',
}
