...
export enum TagTyper {
    ...
    JOBBET_DU_GRADERT = "JOBBET_DU_GRADERT_",
    JOBBET_DU_100_PROSENT = "JOBBET_DU_100_PROSENT_",
    HVOR_MANGE_TIMER_PER_UKE = "HVOR_MANGE_TIMER_PER_UKE_",
    HVOR_MYE_PROSENT = "HVOR_MYE_PROSENT_",
    HVOR_MYE_PROSENT_VERDI = "HVOR_MYE_PROSENT_VERDI_",
    HVOR_MYE_TIMER = "HVOR_MYE_TIMER_",
    HVOR_MYE_TIMER_VERDI = "HVOR_MYE_TIMER_VERDI_",
    HVOR_MYE_HAR_DU_JOBBET = "HVOR_MYE_HAR_DU_JOBBET_",
